...
JNIEXPORT void JNICALL
Java_com_textdraw_editor_NativeBridge_nativeSurfaceChanged(JNIEnv* env, jobject thiz, jint width, jint height) {
...
Java_com_textdraw_editor_NativeBridge_nativeTouchEvent(JNIEnv* env, jobject thiz, jint action, jfloat x, jfloat y, jint pointer_count) {
    ...
    if (action == 0) { // ACTION_DOWN
        ...
        // If not interacting with ImGui UI windows, interact with canvas
